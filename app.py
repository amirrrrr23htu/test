...
country = st.selectbox("Select", ["Tunisia"])
...
if st.button("Calculate CO2 Emissions"):
    ...
    with col4:
        ...
        st.warning("CO2 emissions per capita in Tunisia are equivalent to 2.52 tons per person (based on a population of 11,685,667 in 2016), a dicrease by -0.01 over the figure of 2.52 CO2 tons per person registered in 2015; this represents a change of -0.3% in CO2 emissions per capita.")
